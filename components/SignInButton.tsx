...
export default function SignInButton() {
  ...
  return (
    <>
      {address ? (
        <Wallet>
          <ConnectWallet className="flex h-10 items-center rounded-full bg-transparent p-0 hover:bg-transparent max-md:hidden">
            <Identity
        ...
        <ConnectWallet
          className="h-10 min-w-0 rounded-full bg-primary px-6 font-medium text-primary-foreground hover:bg-primary/90 max-md:hidden"
          text="Sign in"
        />
      )}
    </>
