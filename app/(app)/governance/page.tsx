      ...
      <div className="flex max-w-5xl flex-col gap-6 max-md:max-w-md">
        ...
        <div className="grid grid-cols-3 flex-col gap-6 max-md:flex">
          ...
          <FeatureCard
            ...
            buttonText="Create"
            buttonLink="https://snapshot.org/#/polls.worldassociation.eth/create"
            outlinedButtonText="View polls"
            outlinedButtonLink="https://snapshot.org/#/polls.worldassociation.eth"
          />
          <FeatureCard
            ...
            buttonText="Create"
            buttonLink="https://snapshot.org/#/petitions.worldassociation.eth/create"
            outlinedButtonText="View petitions"
            outlinedButtonLink="https://snapshot.org/#/petitions.worldassociation.eth"
          />
        </div>
      </div>
    </main>
